...
extension Tile {
    static func hydrate(on db: Database) async throws {
        ...
        let tiles = [
            ...
            try Tile(title: "A.I. + Music", user: admin),
            try Tile(title: "A.I. + Pages", user: admin),
            try Tile(title: "A.I. + Keynote", user: admin),
            try Tile(title: "A.I. + Xcode", user: admin),
            ...
            try Tile(title: "A.I. + App Store", user: admin),
            try Tile(title: "A.I. API", user: admin),
            try Tile(title: "Custom A.I. model", user: admin),
